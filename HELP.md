...
* The original package name 'br.com.biroska.native' is invalid and this project uses 'com.example.demo' instead.
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.2.0-SNAPSHOT/maven-plugin/reference/htmlsingle/#aot)
